...
```
git remote add upstream https://github.com/khulnasoft-labs/triangle.git
``` 
("triangle" is used as the example repo. Be sure to reference the _actual_ repo you're contributing to e.g. "triangle-linkerd").
